      ...
      <div className="grid md:grid-cols-3 gap-6 justify-center p-3 mt-6">
        <div>
          <div className="card bg-base-100 shadow-xl hover:scale-105 transition-all">
            ...
            <div className="card-body p-2">
              <h2 className="card-title leading-3 mt-2">Mega News</h2>
        ...
        <div>
          <div className="card bg-base-100 shadow-xl hover:scale-105 transition-all">
            ...
            <div className="card-body p-2">
              <h2 className="card-title leading-3 mt-2">Vibe Palace</h2>
        ...
        <div>
          <div className="card bg-base-100 shadow-xl hover:scale-105 transition-all">
            ...
            <div className="card-body p-2">
              <h2 className="card-title leading-3 mt-2">Dream Venture</h2>

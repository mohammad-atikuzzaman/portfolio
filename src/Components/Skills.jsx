    ...
    <div className="bg-orange-50 p-8 m-8 rounded-xl space-y-8">
      ...
      <div className="grid grid-cols-3 gap-8">
        <div className="flex items-center justify-center text-[#ff6344]">
          <FaHtml5 className="text-xl md:text-7xl md:mr-4"></FaHtml5>
          <div>
            <h4 className="font-semibold text-lg">HTML</h4>
          </div>
        </div>
        <div className="flex items-center justify-center text-blue-600">
          <FaCss3 className="text-xl md:text-7xl md:mr-4"></FaCss3>
          <div>
            <h4 className="font-semibold text-lg">CSS</h4>
          </div>
        </div>
        <div className="flex items-center justify-center text-yellow-500">
          <BiLogoJavascript className="text-xl md:text-7xl md:mr-4"></BiLogoJavascript>
          <div>
            <h4 className="font-semibold text-lg">JavaScript</h4>
          </div>
        </div>
        <div className="flex items-center justify-center text-blue-400">
          <RiTailwindCssFill className="md:text-7xl md:mr-4"></RiTailwindCssFill>
          <div>
            <h4 className="font-semibold text-lg">Tailwind Css</h4>
          </div>
        </div>
        <div className="flex items-center justify-center text-violet-700">
          <FaBootstrap className="text-xl md:text-7xl md:mr-4"></FaBootstrap>
          <div>
            <h4 className="font-semibold text-lg">BootStrap</h4>
          </div>
        </div>
        <div className="flex items-center justify-center text-blue-400">
          <FaReact className="text-xl md:text-7xl md:mr-4"></FaReact>
          <div>
            <h4 className="font-semibold text-lg">React Js</h4>
          </div>
        </div>
        <div className="flex items-center justify-center">
          <SiNextdotjs className="text-xl md:text-7xl md:mr-4"></SiNextdotjs>
          <div>
        ...
        <div className="flex items-center justify-center text-green-600">
          <FaNodeJs className="text-xl md:text-7xl md:mr-4"></FaNodeJs>
          <div>
        ...
        <div className="flex items-center justify-center">
          <SiExpress className="text-xl md:text-7xl md:mr-4"></SiExpress>
          <div>
            <h4 className="font-semibold text-lg">Express Js</h4>
          </div>
        </div>
        <div className="flex items-center justify-center text-green-700">
          <SiMongodb className="text-xl md:text-7xl md:mr-4"></SiMongodb>
          <div>

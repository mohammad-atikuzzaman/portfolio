        ...
        <div className="grid grid-cols-3 gap-8">
          <div className="flex items-center justify-center text-[#ff6344]">
            ...
            <div>
              ...
              <div
                className="radial-progress  text-[#ff6344]  "
                style={{ "--value": 90 }}
                role="progressbar">
                90%
              </div>
          ...
          <div className="flex items-center justify-center text-yellow-500">
            ...
            <div>
              ...
              <div
                className="radial-progress text-500"
                style={{ "--value": 90 }}
                role="progressbar">
                90%
              </div>
          ...
          <div className="flex items-center justify-center text-violet-700">
            ...
            <div>
              ...
              <div
                className="radial-progress text-violet-700"
                style={{ "--value": 90 }}
                role="progressbar">
                90%
              </div>
          ...
          <div className="flex items-center justify-center text-green-700">
            ...
            <div>
              ...
              <div
                className="radial-progress  text-green-700"
                style={{ "--value": 90 }}
                role="progressbar">
                60%
              </div>

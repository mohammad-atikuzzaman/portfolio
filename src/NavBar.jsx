...
const NavBar = () => {
  return (
    <div className="navbar py-0 bg-base-100 border-2 border-green-600 rounded-full mt-4">
        ...
        <ul className="menu menu-horizontal px-1 font-semibold">
          <li>
            <NavLink
              to={"/"}
              className={({ isActive }) =>
                isActive ? "font-black border-b-2 border-green-600" : ""
              }
            >
              Home
            </NavLink>
          ...
          <li>
            <NavLink
              to={"/about"}
              className={({ isActive }) =>
                isActive ? "font-semibold border-b-2 border-green-600" : ""
              }
            >
              About
            </NavLink>
